        ...
        <div className="footer__grid">
          ...
          <div className="footer__section">
            ...
            <div className="footer__social">
              <a href="#" className="footer__social-link" aria-label="Facebook">
                <svg className="footer__social-icon" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              ...
              <li>
                <Link to="/clients" className="footer__link">
                  Clients
                </Link>
              </li>
              <li>
          ...
          <div className="footer__section">
            ...
            <p className="footer__description">
              Subscribe to our newsletter for the latest updates and tips on managing your freelance business.
            </p>
